...
public class Utils {
    ...
    public static File createFile(Context reactContext, String fileType) {
        try {
            ...
            // File fileDir = reactContext.getDir("fw_images", Context.MODE_WORLD_WRITEABLE);
            File fileDir = reactContext.getExternalFilesDir("fw_images");
